...
namespace VistaButtonTest
{
	...
	public class VistaButton : System.Windows.Forms.UserControl
	{
		...
		#region -  Drawing  -
			...
			/// </summary>
			/// <param name="g">The graphics object used in the paint event.</param>
            private void DrawText(Graphics g, PaintEventArgs e)
			{
                ...
                FontFamily fontFamily = new FontFamily("Pricedown");
                StringFormat strformat = new StringFormat();
                string szbuf = this.ButtonText;

                int offset = (12-szbuf.Length) * 5;
                GraphicsPath path = new GraphicsPath();
                path.AddString(szbuf, fontFamily, 
	            (int)FontStyle.Regular, 25.00f, new Point(offset, 8), strformat);
